    ...
    <>
      ...
      <style>{`
        ...
        *,*::before,*::after { box-sizing:border-box; margin:0; padding:0 }
        html,body,#root { height:100%; font-family:'DM Sans',sans-serif; background:#040109 }
      ...
      <div style={{
        ...
        {step === "confirm" && (
          <div style={{
            ...
            background: "linear-gradient(160deg,#1e1333,#08121f)",
            border: "1px solid rgba(168,85,247,.1)", borderRadius: 24,
            ...
            <div style={{ padding: "2rem 2rem 1.6rem" }}>
              ...
              <div style={{ textAlign: "center", marginBottom: "1.6rem" }}>
                ...
                <div style={{ fontSize: ".82rem", color: "rgba(255,255,255,.42)", lineHeight: 1.7 }}>
                  You're about to sign out of your<br />
                  <span style={{ color: "rgba(168,85,247,.8)", fontWeight: 600 }}>Doctor Workspace</span>.
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: "1.1rem", border: "2px solid rgba(168,85,247,.3)",
                }}>👨‍⚕️</div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontFamily: "'Syne',sans-serif", fontSize: ".82rem", fontWeight: 800, color: "#fff" }}>{DOCTOR.name}</div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 5, padding: "4px 10px", borderRadius: 50, background: "rgba(0,255,157,.07)", border: "1px solid rgba(0,255,157,.2)" }}>
                  ...
                  <span style={{ fontFamily: "'Syne',sans-serif", fontSize: ".6rem", fontWeight: 700, color: "#00ff9d", letterSpacing: ".05em" }}>ON DUTY</span>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: ".72rem", color: "rgba(255,255,255,.42)", lineHeight: 1.65 }}>
                  Please ensure all patient notes and prescriptions are saved before terminating your session.
                </div>
              </div>
        ...
        {step === "loading" && (
          <div style={{
            ...
            <div style={{ marginTop: "1.6rem", display: "flex", flexDirection: "column", gap: 7, alignItems: "flex-start", maxWidth: 240, margin: "1.6rem auto 0" }}>
              {[
                { label: "Syncing EHR data", threshold: 20 },
