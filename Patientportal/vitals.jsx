...
export default function VitalsPage() {
  ...
  useEffect(() => {
    const id = setInterval(() => setHeartRate(70 + Math.floor(Math.random() * 9)), 2000);
    return () => clearInterval(id);
  }, []);

  const hrData = [68, 71, 74, 70, 73, 75, 72, 74, 76, 73, 72, 74, 71, 75, 73, heartRate];
  const spo2Data = [97, 98, 98, 99, 98, 97, 98, 98, 99, 98, 98, 97, 98, 99, 98, 98];
  const tempData = [36.4, 36.5, 36.6, 36.5, 36.7, 36.6, 36.5, 36.6, 36.7, 36.6, 36.5, 36.6, 36.7, 36.6, 36.6, 36.6];
  const bpSysData = [118, 120, 116, 119, 118, 121, 117, 119, 120, 118, 116, 119, 118, 120, 117, 118];

  const history = [
    { date: "Mar 09, 2026 · 10:30 AM", hr: 72, spo2: 98, temp: 36.6, bp: "118/76", note: "Morning reading — normal" },
    { date: "Mar 09, 2026 · 08:00 AM", hr: 68, spo2: 99, temp: 36.5, bp: "115/74", note: "Woke up — resting state" },
    { date: "Mar 08, 2026 · 09:45 PM", hr: 78, spo2: 97, temp: 36.8, bp: "122/80", note: "After light exercise" },
    { date: "Mar 08, 2026 · 02:00 PM", hr: 74, spo2: 98, temp: 36.6, bp: "119/77", note: "Afternoon — stable" },
    { date: "Mar 08, 2026 · 09:00 AM", hr: 70, spo2: 98, temp: 36.5, bp: "116/75", note: "Morning reading — normal" },
    { date: "Mar 07, 2026 · 10:15 PM", hr: 76, spo2: 97, temp: 36.7, bp: "120/78", note: "Slight elevation — monitored" },
    { date: "Mar 07, 2026 · 11:00 AM", hr: 73, spo2: 99, temp: 36.6, bp: "117/76", note: "Normal — post breakfast" },
    { date: "Mar 06, 2026 · 09:30 AM", hr: 69, spo2: 98, temp: 36.4, bp: "114/73", note: "Good morning vitals" },
  ];
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                ...
                <div className="card" style={{ animationDelay: ".05s" }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-around", alignItems: "center", flexWrap: "wrap", gap: "1rem", padding: ".5rem 0" }}>
                    ...
                    <RingGauge value={98} max={100} color="#00c8ff" size={110} label="SpO₂" unit="%" />
                    <RingGauge value={366} max={400} color="#ffd93d" size={110} label="Temperature" unit="°C" />
                    <RingGauge value={118} max={200} color="#a78bfa" size={110} label="Systolic BP" unit="mmHg" />
                    <RingGauge value={76} max={120} color="#f472b6" size={110} label="Diastolic BP" unit="mmHg" />
                  </div>
                </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                  ...
                  <VitalCard icon="🌡️" label="Temperature" value="36.6" unit="°C" color="#ffd93d" status="Normal" statusColor="#00ff9d" data={tempData} trend={-0.3} delay=".22s" />
            ...
            {activeTab === "history" && (
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                ...
                <div className="card" style={{ animationDelay: ".05s" }}>
                  ...
                  {[
                    {
                      date: "Mar 09, 2026", day: "Today", badge: "#00ff9d",
                      avg: { hr: 70, spo2: 98, temp: 36.6, bp: "116/75" },
                      rows: [
                        { time: "10:30 AM", hr: 72, spo2: 98, temp: 36.6, bp: "118/76", note: "Morning reading — normal" },
                        { time: "08:00 AM", hr: 68, spo2: 99, temp: 36.5, bp: "115/74", note: "Woke up — resting state" },
                      ]
                    },
                    {
                      date: "Mar 08, 2026", day: "Yesterday", badge: "#00c8ff",
                      avg: { hr: 74, spo2: 97, temp: 36.7, bp: "120/79" },
                      rows: [
                        { time: "09:45 PM", hr: 78, spo2: 97, temp: 36.8, bp: "122/80", note: "After light exercise" },
                        { time: "02:00 PM", hr: 74, spo2: 98, temp: 36.6, bp: "119/77", note: "Afternoon — stable" },
                        { time: "09:00 AM", hr: 70, spo2: 98, temp: 36.5, bp: "116/75", note: "Morning reading — normal" },
                      ]
                    },
                    {
                      date: "Mar 07, 2026", day: "2 days ago", badge: "#a78bfa",
                      avg: { hr: 75, spo2: 98, temp: 36.7, bp: "119/77" },
                      rows: [
                        { time: "10:15 PM", hr: 76, spo2: 97, temp: 36.7, bp: "120/78", note: "Slight elevation — monitored" },
                        { time: "11:00 AM", hr: 73, spo2: 99, temp: 36.6, bp: "117/76", note: "Normal — post breakfast" },
                      ]
                    },
                    {
                      date: "Mar 06, 2026", day: "3 days ago", badge: "#ffd93d",
                      avg: { hr: 71, spo2: 98, temp: 36.5, bp: "115/74" },
                      rows: [
                        { time: "09:30 AM", hr: 69, spo2: 98, temp: 36.4, bp: "114/73", note: "Good morning vitals" },
                        { time: "03:00 PM", hr: 72, spo2: 98, temp: 36.6, bp: "116/75", note: "Afternoon — normal" },
                      ]
                    },
                    {
                      date: "Mar 05, 2026", day: "4 days ago", badge: "#f472b6",
                      avg: { hr: 73, spo2: 97, temp: 36.6, bp: "118/77" },
                      rows: [
                        { time: "08:45 PM", hr: 77, spo2: 97, temp: 36.7, bp: "121/79", note: "Evening — slight exertion" },
                        { time: "12:30 PM", hr: 72, spo2: 98, temp: 36.5, bp: "117/76", note: "Post lunch — normal" },
                        { time: "08:00 AM", hr: 70, spo2: 97, temp: 36.6, bp: "116/76", note: "Morning reading" },
                      ]
                    },
                  ].map((day, di) => (
                    <DayGroup key={di} {...day} defaultOpen={di === 0} />
                  ))}
                </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                  {[
                    ...
                    { label: "SpO₂ — 7 Day Trend", data: [98, 97, 98, 99, 98, 98, 98], color: "#00c8ff" },
                    { label: "Temperature — 7 Day Trend", data: [36.5, 36.6, 36.5, 36.7, 36.6, 36.6, 36.6], color: "#ffd93d" },
                    { label: "Systolic BP — 7 Day Trend", data: [118, 120, 117, 119, 121, 118, 118], color: "#a78bfa" },
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                ...
                <div className="card" style={{ animationDelay: ".2s" }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: ".8rem" }}>
                    {[
                    ...
                    ].map(({ label, thisWeek, lastWeek, change, color }) => (
                      <div key={label} style={{ padding: "12px", borderRadius: 12, background: "rgba(255,255,255,.03)", border: "1px solid rgba(255,255,255,.06)" }}>
                        ...
                        <span style={{ fontSize: ".65rem", fontWeight: 600, color: change < 0 ? "#00ff9d" : change > 0 ? "#ff6b6b" : "rgba(255,255,255,.3)" }}>
                          {change < 0 ? "▼" : "▲"} {Math.abs(change)}% {change < 0 ? "improved" : "increased"}
                        </span>
                      </div>
                    ))}
                  </div>
